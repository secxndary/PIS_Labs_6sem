...
namespace PIS_Lab5a
{
    public class RouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute("M01_1", "", new { controller = "MResearch", action = "M01" });
            routes.MapRoute("M01_2", "MResearch", new { controller = "MResearch", action = "M01" });
            routes.MapRoute("M01_3", "MResearch/M01", new { controller = "MResearch", action = "M01" });
            routes.MapRoute("M01_4", "MResearch/M01/1", new { controller = "MResearch", action = "M01" });
